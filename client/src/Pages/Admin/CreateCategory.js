...
//         try {
//             const response = await axios.post("http://localhost:8000/api/category/create-category", {
...
//         try {
//             const response = await axios.put(`http://localhost:8000/api/category/create-category/${id}`, {
//                 Headers: {
//                     Authorization: token,
//                 }
//             })
...
//         setName(categories.find(category => category._id === id).name)
